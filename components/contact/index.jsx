      ...
      <div style={{ width: "100vw" }}>
        ...
        >
          ...
          <div className="col-sm-12 col-md-7 px-0-sm pt-2-sm">
            <form
              action="mailto:jonathangobiel13@gmail.com"
            ...
            >
              ...
              >
                <div
                  ...
                  style={{
                    width: 80,
                    height: 80,
                    backgroundColor: "rgba(252, 89, 106,1)",
                    color: "white",
                    fontSize: "2.1rem",
                  }}
                >
              ...
              <div className="p-5">
                ...
                <div className="d-flex mt-3">
                  <button
                    type="submit"
                    className="ml-auto btn btn-sm bg-transparent font-semi-bold"
                    style={{
                      borderRadius: 0,
